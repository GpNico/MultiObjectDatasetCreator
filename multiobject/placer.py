...
class Placer:
    ...
    def place(self, relation):
        ...
        if relation in self.rela_2_obj:
            ...
            x, image_labels, fail_flag = self._place_3_obj(placement, add_noise = self.noise)
            image_labels[-1] = self.relations_code[relation]
    ...
    def _place_2_obj(self, placement, add_noise = False):
        ...
        while curr_attempts < 100:
            try:
                r_2, c_2 = placement(r_1, c_1, obj_size_1, obj_size_2, self.x.shape)
    ...
    def _place_3_obj(self, placement, add_noise = False):
        ...
        while curr_attempts < 100:
            ...
            r_2 = np.random.randint(self.x.shape[0] - obj_size_2[0] + 1)
            c_2 = np.random.randint(self.x.shape[1] - obj_size_2[1] + 1)
        ...
        while curr_attempts < 100:
            try:
                r_3, c_3 = placement(r_1, c_1, obj_size_1, r_2, c_2, obj_size_2, obj_size_3, self.x.shape)
